...
description: Optimistically route HIGH confidence requests to Haiku with validation and auto-escalate to Sonnet if validation fails. Enables 35-40% additional quota savings for simple mechanical tasks.
model: sonnet
